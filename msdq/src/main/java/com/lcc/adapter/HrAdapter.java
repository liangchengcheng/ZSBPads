...
public class HrAdapter extends LoadMoreRecyclerAdapter<HrEntity,HrAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hr_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindItemViewHolder(ViewHolder holder, final int position) {
        HrEntity entity=getItem(position);
    ...
    public interface OnItemClickListener{
        void OnItemClick(HrEntity entity);
    }
}

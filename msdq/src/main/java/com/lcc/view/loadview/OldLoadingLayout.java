 ...
 * Description:  显示不同的界面适用于listview的的界面
 */

public class OldLoadingLayout extends FrameLayout {

    private int emptyView, errorView, loadingView;
    private OnClickListener onRetryClickListener;

    public OldLoadingLayout(Context context) {
        this(context, null);
    }

    public OldLoadingLayout(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public OldLoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {

...
public class HrFragment extends RefreshAndLoadFragment implements HrAdapter.OnItemClickListener{
    ...
    protected void onFragmentCreate() {
        ...
        mAdapter = new HrAdapter(getActivity());
        setAdapter(mAdapter);
    ...
    @Override
    public void OnItemClick(HrEntity entity) {

    }

    private List<HrEntity> getData(){
        List<HrEntity> data=new ArrayList<>();
        for (int i=0;i<10;i++){
            HrEntity zxTest=new HrEntity();

package zsbpj.lccpj.view.progress;
...
public class VideoProgressWheel  extends View {
     ...
     * @param attrs
     */
    public VideoProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.VideoProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.VideoProgressWheel_pwBarWidth, barWidth);
        rimWidth = (int) a.getDimension(R.styleable.VideoProgressWheel_pwRimWidth, rimWidth);
        spinSpeed = (int) a.getDimension(R.styleable.VideoProgressWheel_pwSpinSpeed, spinSpeed);
        barLength = (int) a.getDimension(R.styleable.VideoProgressWheel_pwBarLength, barLength);

        delayMillis = a.getInteger(R.styleable.VideoProgressWheel_pwDelayMillis, delayMillis);
        if (delayMillis < 0) { delayMillis = 10; }

        // Only set the text if it is explicitly defined
        if (a.hasValue(R.styleable.VideoProgressWheel_pwText)) {
            setText(a.getString(R.styleable.VideoProgressWheel_pwText));
        }

        barColor = a.getColor(R.styleable.VideoProgressWheel_pwBarColor, barColor);
        textColor = a.getColor(R.styleable.VideoProgressWheel_pwTextColor, textColor);
        rimColor = a.getColor(R.styleable.VideoProgressWheel_pwRimColor, rimColor);
        circleColor = a.getColor(R.styleable.VideoProgressWheel_pwCircleColor, circleColor);
        contourColor = a.getColor(R.styleable.VideoProgressWheel_pwContourColor, contourColor);

        textSize = (int) a.getDimension(R.styleable.VideoProgressWheel_pwTextSize, textSize);
        contourSize = a.getDimension(R.styleable.VideoProgressWheel_pwContourSize, contourSize);
